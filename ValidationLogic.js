...
function search(form) {
    alert("umbrella");
    console.log("MEAL: "+form.meal_type.value);
    console.log("PRICE: "+form.price.value);
    console.log("SEARCH: "+form.search_area.value);
...
function getSearchParameter(form) {
    ...
    if (failmsg == "") {
        ...
        if (form.price.value == "0") {
            ...
            min = 1;
            max = 1;
        } else if (form.price.value == "2") {
            min = 1;
            max = 2;
        } else if (form.price.value == "3") {
            min = 2;
            max = 3;
        } else if (form.price.value == "4") {
            min = 3;
            max = 4;
        } else if (form.price.value == "5") {
            min = 0;
            max = 0;
        }
